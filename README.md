[![Build Status](https://github.com/opspec-pkgs/docker.config.clean/workflows/build/badge.svg?branch=master)](https://github.com/opspec-pkgs/docker.config.clean/actions?query=workflow%3Abuild+branch%3Amaster)
